...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.GET("/images/tasks/:task_id/images/:index", h.AsyncImage.DownloadImage)
	...
	r.GET("/images/tasks/:task_id/images/:index", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, h.AsyncImage.DownloadImage)
