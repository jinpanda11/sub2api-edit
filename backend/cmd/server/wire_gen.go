...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	lotteryService := service.NewLotteryService(client, userRepository, lotteryChanceRepository, lotteryRecordRepository, settingRepository, billingCacheService, redisClient)
	...
	consumptionRankingService := service.NewConsumptionRankingService(client, redisClient, settingRepository)
