...
const (
	// Label holds the string label denoting the lotteryrecord type in the database.
	Label = "lottery_record"
	...
	FieldSource = "source"
	// Table holds the table name of the lotteryrecord in the database.
	Table = "lottery_records"
)

// Columns holds all SQL columns for lotteryrecord fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the LotteryRecord queries.
