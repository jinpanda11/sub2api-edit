export default {
    settings: {
      ...
      features: {
        ...
        lottery: {
          title: '每日盲盒抽奖',
          description: '用户通过每日登录、充值/兑换码入账获得抽奖次数，开启盲盒即时获得余额奖励。',
          enabled: '启用抽奖',
          enabledHint: '关闭后抽奖页面显示已停用状态，抽奖请求被拒绝。',
          minAmount: '单次中奖最低金额',
          maxAmount: '单次中奖最高金额',
          rechargeUnit: '每充值多少个余额单位赠送 1 次',
          rechargeDailyMax: '充值来源每日次数上限',
          loginReward: '每日登录奖励次数',
        },
        consumptionRanking: {
          title: '每日消费排行榜',
          description: '公开的消费 Top 20 排行榜页面（/ranking），邮箱已脱敏。',
          enabled: '启用排行榜',
          enabledHint: '关闭后排行榜页面显示已停用状态，公开接口返回空列表。',
        },
      },
