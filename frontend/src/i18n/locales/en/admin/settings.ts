export default {
    settings: {
      ...
      features: {
        ...
        lottery: {
          title: 'Daily Blind-Box Lottery',
          description: 'Users earn chances by logging in daily and by recharging / redeeming codes, then open mystery boxes for instant balance rewards.',
          enabled: 'Enable Lottery',
          enabledHint: 'When off, the lottery page shows a disabled state and draws are rejected.',
          minAmount: 'Min Prize',
          maxAmount: 'Max Prize',
          rechargeUnit: 'Recharge Unit per Chance',
          rechargeDailyMax: 'Recharge Chances Daily Cap',
          loginReward: 'Daily Login Reward (chances)',
        },
        consumptionRanking: {
          title: 'Daily Consumption Ranking',
          description: 'Public top-20 consumption ranking page (/ranking) with masked emails.',
          enabled: 'Enable Ranking',
          enabledHint: 'When off, the ranking page shows a disabled state and the public API returns an empty list.',
        },
      },
