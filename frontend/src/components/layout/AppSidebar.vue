...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/draw', label: t('nav.imagePlayground'), icon: BeakerIcon, hideInSimpleMode: true },
    { path: '/ranking', label: t('nav.consumptionRanking'), icon: TrophyIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/lottery', label: t('admin.lottery.title'), icon: ChartIcon },
